...
export function AppShell() {
  return <div className="app-shell">
    ...
    <div className="workspace-column"><header className="workspace-header"><span>Workspace Engine</span><div><span className="local-badge"><i className="status-dot" />Local First</span><span className="profile-glyph" aria-label="Private profile"><UserRound size={16} /></span></div></header><main className="main-workspace"><Outlet /></main></div>
  </div>;
}
